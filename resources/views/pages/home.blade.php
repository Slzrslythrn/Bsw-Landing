<x-app-layout>
    <section class="hero-section d-flex justify-content-center align-items-center" id="section_1"
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="container" style="margin-left: 100px;">
                    <a class="text-#387799" style="font-size: 48px;font-family:sans-serif;font-weight: bold">Bogor <span
                            style="color:#f39f55;font-size: 48px">Single</span> Window</a>

                    <h6 class="text-#387799" style="font-family: sans-serif;font-size:26px;font-weight: bold"><a>Portal
                            Aplikasi Pemerintah Kota Bogor Memberikan</a>
        ...
        <img src="{{ asset('images/topics/header.png') }}"
            style="max-width: 20%;margin-right:150px;padding-bottom:40px;">
    </section>
    ...
    <section class="featured-section">
        <div class="container">
                                ...
                                @foreach ($dataTerbanyak['data'] as $row)
                                    <div class="col-md-2">
                                        <a href="{{ isset($row['link_sso']) ? $row['link_sso'] : $row['link_website'] }}"
                                            target="_blank">
                                            <div class="card shadow p-3" style="width: 10rem; margin-top: 80px">
            ...
            <div class="d-flex  justify-content-center align-items-center position-relative">
                <div class="position-absolute start-50 translate-middle" style="top: 20px; z-index:3;margin-top:-70px">
                    <a href="#section_2" class="btn btn-warning smoothscroll fa-solid fa-angle-down"
                        style="width: 200px;height:40px;padding-top:10px;border-radius:30px;"></a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="explore-section" id="section_2">
        ...
        <div class="row" id="section_2">
            <div class="col-12 text-center">
                <h3 class="" style="color: #325358; margin-top:20px; font-weight: 800">APLIKASI PEMERINTAH KOTA
                    BOGOR
                </h3>
            </div>
