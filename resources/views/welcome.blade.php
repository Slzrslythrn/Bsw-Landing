    ...
    <body id="top">
        ...
        <main>
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <div class="button">
                            <button class="btn btn-primary"><a href="dashboard" style="color: white">Login SSO</a></button>
                        </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex  justify-content-center align-items-center position-relative">
                ...
                <button type="button" class="btn btn-warning" style="width: 200px"><a class="click-scroll" href="#section_2">Drop</a></button>
                </div>    
            </div>
                        ...
                        <div class="col-12 d-flex">    
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="design-tab-pane" role="tabpanel" aria-labelledby="design-tab" tabindex="0">
                                    <div class="row">
                                        <div class="col-lg-2 col-md-3 col-12 mb-3 mb-lg-0" style="height: 250px; width:180px">
                                            <div class="custom-block bg-white shadow-lg">
                                                <a href="topics-detail.html">
                                                    ...
                                                    <img src="images/topics/1.png" class="custom-block-image img-fluid" alt="">
                                                </a>
                                            </div>
                                        </div>

                                        <div class="col-lg-2 col-md-6 col-16 mb-6 mb-lg-0"  style="height: 250px; width:180px">
                                            <div class="custom-block bg-white shadow-lg">
                                                <a href="topics-detail.html">
                                                    <div class="d-flex">
                                                        <div>
                                        ...
                                        <div class="col-lg-2 col-md-6 col-16 mb-6 mb-lg-0"  style="height: 250px">
                                            <div class="custom-block bg-white shadow-lg">
                                                <a href="topics-detail.html">
                                                    <div class="d-flex">
                                                        <div>
